...
import CQPG_RETURNEVALUATION from '@salesforce/label/c.CQPG_RETURNEVALUATION';
...
export default class cquiPGComplaintEdit  extends cquiComplaintEdit {
    ...
    get CQPG_RETURNEVALUATION() {
        return CQPG_RETURNEVALUATION;
    }
